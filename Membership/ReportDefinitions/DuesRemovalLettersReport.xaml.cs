...
{
    public partial class DuesRemovalLettersReport : INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty MyPropertyProperty =
            DependencyProperty.Register("TableOfficers", typeof(IEnumerable<Officer>),
                typeof(DuesRemovalLettersReport));
        ...
        public DuesRemovalLettersReport()
        {
            InitializeComponent();
        ...
        {
            ReportControl.ReportName = "DuesRemovalLetters";
