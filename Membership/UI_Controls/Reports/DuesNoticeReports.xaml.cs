...
{
    public partial class DuesNoticeReports : ReportUserControlBase, INotifyPropertyChanged
    {
        private readonly ReportDatasetPresenter _presenter;

        public IEnumerable<Officer> TableOfficers
        {
            get => (IEnumerable<Officer>)GetValue(MyPropertyProperty);
        ...
        {
            get => (Officer)GetValue(SelectedOfficeProperty);
        ...
        protected override IEnumerable<ReportDataSource> LoadDataSets()
        {
            ...
            var membersList = new List<Member>(_presenter.GetMembersFromList(membersThatOwe));
